                ...
                <div className='flex justify-center items-center gap-8 relative'>
                    <div className='flex justify-center items-center'>
                        <div className='flex justify-center items-center gap-3'>
                            ...
                            {
                                userInfo.role === 'admin' ? <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src=" https://nile-hope-client.vercel.app/images/admin.jpg" alt="" /> : <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src=" https://nile-hope-client.vercel.app/images/seller.png" alt="" />
                            }
                        </div>
                    </div>
                </div>
