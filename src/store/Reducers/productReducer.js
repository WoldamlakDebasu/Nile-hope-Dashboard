...
export const productReducer = createSlice({
    ...
    reducers: {
        ...
        deleteProductFromList: (state, action) => {
            ...
            state.totalProduct -= 1; // Decrement total product count
        },
    },
    extraReducers: {
        ...
        [delete_product.fulfilled]: (state, { payload }) => {
            state.loader = false;
            state.successMessage = payload.message;
            // Dispatch the deleteProductFromList action to update the state
            state = deleteProductFromList(state, payload.productId);
        },
    
    }

})
export const { messageClear,deleteProductFromList } = productReducer.actions
