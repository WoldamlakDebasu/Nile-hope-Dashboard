                ...
                <div className='w-full p-4  bg-[#283046] rounded-md'>
                    <div className='w-full flex flex-wrap text-[#d0d2d6]'>
                        <div className='w-3/12 flex justify-center items-center py-3'>
                            <div>
                                {
                                    seller?.shopInfo?.license ? <img className='' src={seller?.shopInfo?.license }alt="" /> : <span>Image not uploaded</span>
                                }
                        ...
                        <div className='w-4/12'>
                            <div className='px-0 md:px-5 py-2'>
                                ...
                                <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md'>
                                    ...
                                    <div className='flex gap-2'>
                                    <span>Subcity : </span>
                                        <span>{seller?.shopInfo?.subCity}</span>
                                    </div>
                                    <div className='flex gap-2'>
                                        <span>Worreda : </span>
                                        <span>{seller?.shopInfo?.woreda}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
